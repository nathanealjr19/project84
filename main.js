...
function add() {
  img_Tag = new Image(); //defining a variable with a new image
  img_Tag.onload = uploadimg; // setting a function, onloading this variable
  img_Tag.src = img_image; // load image
}
